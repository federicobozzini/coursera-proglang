...
(check-equal? (string-append-map 
                  null
                  ".jpg") null "string-append-map test2")


   ; list-nth-mod test
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 2) 2 "list-nth-mod test")
   (check-equal? (list-nth-mod (list 0 1 2 3 4) 0) 0 "list-nth-mod test2")
   ...
   (check-equal? (stream-for-n-steps (stream-add-zero funny-number-stream) 3) (list (cons 0 1) (cons 0 2) (cons 0 3)) "stream-add-zero test2")
   ...
   (check-equal? (vector-assoc 4 (vector)) #f "vector-assoc test2")
   (check-equal? (vector-assoc -5 (vector (cons 2 1) (cons 3 1) (cons 4 1) (cons 5 1))) #f "vector-assoc test3")
