...
b4 = b.intersect(Line.new(-THREE,FIVE))
if not (((b4.is_a? Point) and b4.x == ZERO and b4.y == FIVE))
	puts "Line intersect with line not working properly"
end
b5 = b.intersect(Point.new(THREE,14.0))
if not (((b5.is_a? Point) and b5.x == THREE and b5.y == 14.0))
	puts "Line intersect with point not working properly"
end
b6 = Point.new(THREE,14.0).intersect(b)
if not (((b6.is_a? Point) and b6.x == THREE and b6.y == 14.0))
