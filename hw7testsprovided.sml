...
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "preprocess 2 flips an improper LineSegment successfully\n")
	else (print "preprocess 2 does not flip an improper LineSegment successfully\n")
end;
...
in
	if real_equal(a,e) andalso real_equal(b,f) andalso real_equal(c,g) andalso real_equal(d,h)
	then (print "preprocess 3 flips an improper LineSegment successfully\n")
	else (print "preprocess 3 does not flip an improper LineSegment successfully\n")
end;
