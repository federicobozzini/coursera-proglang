...
class Point < GeometryValue
  ...
  def intersectWithSegmentAsLineResult s
	...
	if inbetween(x,s.x1,s.x2) and inbetween(y,s.y1,s.y2)
	    self
	else 
	    NoPoints.new
	end  
...
class Let < GeometryExpression
  ...
  def eval_prog env
    ...
    newEnv.unshift([@s, @e1.eval_prog(newEnv)])
    @e2.eval_prog newEnv
  end
